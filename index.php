...
<head>
    ...
    <title>Fortune Forever | Home</title>
        ...
        <div class="content" onclick="hide()">
            <div class="wrapper">
                <div class="main-content">
                    <img src="assets/images/home-banner.jpg" alt="Slider"  />
                    <div class="main-text">
                        <h2>BE A PART OF THANE'S UTOPIAN NEIGHBOURHOOD</h2>
                        <p>WORLD CLASS 1 & 2 BED RESIDENCES STARTING FROM 58.7 LAC+.</p>
                        <p>Apply during the early booking window from 20<sup>th</sup> to 28<sup>th</sup> FEB and avail a NRI privilege offer of INR 1.26 Lakhs onwards</p>
                    </div>
                </div>
            </div>
        </div>
