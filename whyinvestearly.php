...
<html lang="en">
  ...
  <head>
    ...
    <title>Fortune Forever | Why Invest Early</title>
            ...
            <div class="wrapper cf">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="whyinvestearly.php" title="Why Invest Early" class="active">Why Invest Early</a></li>
        ...
        <div class="content" onclick="hide()">
            <div class="wrapper">
                <div class="why-content">
                    <h2>Why Invest Early?</h2>
                    <p>Book for Rs. 54,000 today plus stamp duty and registration. EMI starts after 4 years.</p>
                    <div class="apply-the">
                        <p>APPLY DURING THE EARLY BOOKING WINDOW FROM 20<sup>TH</sup> FEB TO 28<sup>TH</sup> FEB AND AVAIL A SPECIAL PRIVILENGE OF RS. 1.26 LAC+</p>
                    </div>
                    <div class="img-wrap">
                        <p>
                            <img src="assets/images/img-1.jpg" alt="Img"  />
                            <span>Time is on your side</span>
                            <span>The sooner you invest, the better returns you get.</span>
                        </p>
                        <p>
                            <img src="assets/images/img-2.jpg" alt="Img"  />
                            <span>India becoming more investor friendly</span>
                            <span>Affordable housing made easy.</span>
                        </p>
                        <p>
                            <img src="assets/images/img-3.jpg" alt="Img"  />
                            <span>Banks favour the young</span>
                            <span>Easy financing for young professionals.</span>
                        </p>
                    </div> 
                </div>
            </div>
